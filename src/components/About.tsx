  ...
  return (
    <section
      ...
      className="relative min-h-screen flex flex-col items-center justify-center 
                 bg-[url('/textures/light-texture.svg')] bg-cover bg-center lazy-load 
    ...
    >
      ...
      <motion.div
        ...
        aria-hidden="true"
      >
        <motion.div className="absolute top-10 left-10 w-32 h-32 bg-pink-300 rounded-full blur-2xl"></motion.div>
        <motion.div className="absolute bottom-20 right-20 w-40 h-40 bg-yellow-400 rounded-lg rotate-12 blur-lg"></motion.div>
        <motion.div className="absolute top-40 right-40 w-24 h-24 bg-teal-400 rounded-full blur-lg"></motion.div>
      </motion.div>
